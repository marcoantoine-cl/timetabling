...
public class DatosIniciales implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        // dictar varios ramos a un mismo curso (la tupla es <Curso,Profesor,Ramo,Sala>).
        ramoRepository.guardar(ramo("R-LEN-C1", "Lenguaje", "C1", "P1", 6, "R2", true, null));
        ramoRepository.guardar(ramo("R-MAT-C1", "Matematica", "C1", "P2", 6, "R2", true, null));
        ramoRepository.guardar(ramo("R-ORI-C1", "Orientacion", "C1", "P1", 1, "R2", false,
                List.of(new TimeSlotDto(4, 1))));
        ramoRepository.guardar(ramo("R-EDF-C1", "Educacion Fisica", "C1", "P3", 2, "R1", false, null));

        ramoRepository.guardar(ramo("R-LEN-C2", "Lenguaje", "C2", "P2", 6, "R3", true, null));
        ramoRepository.guardar(ramo("R-MAT-C2", "Matematica", "C2", "P1", 6, "R3", true, null));
        ramoRepository.guardar(ramo("R-ORI-C2", "Orientacion", "C2", "P2", 1, "R3", false,
                List.of(new TimeSlotDto(4, 1))));
